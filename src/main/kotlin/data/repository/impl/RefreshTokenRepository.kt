...
class RefreshTokenRepository : IRefreshTokenRepository {
    ...
    override suspend fun saveToken(userId: UUID, token: String, expiresAt: Instant): Boolean = transaction {
    ...
    override suspend fun isTokenValid(token: String): Boolean = transaction {
    ...
    override suspend fun revokeToken(token: String): Boolean = transaction {
    ...
    override suspend fun revokeAllUserTokens(userId: UUID): Boolean = transaction {
    ...
    override suspend fun findByToken(token: String): RefreshTokenData? = transaction {
